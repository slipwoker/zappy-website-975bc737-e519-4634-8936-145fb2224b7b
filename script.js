document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyScrollAnimations() {
    const animatableEls = document.querySelectorAll(
      '.' + OBSERVE_CLASS + ', [data-animate], .animate-on-scroll'
    );
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '975bc737-e519-4634-8936-145fb2224b7b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '975bc737-e519-4634-8936-145fb2224b7b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '975bc737-e519-4634-8936-145fb2224b7b';
